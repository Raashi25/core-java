class FacebookRegistration {
    ...
    public static boolean registration(String gName, boolean gIndian, String gDob, String gEmail, long gMobile) {
        ...
        boolean isValidated = FacebookRegistrationValidator.validateUser(gName, gIndian, gDob, gEmail, gMobile);
        if (isValidated == true) {
    ...
    public static void getDetails() {
        fullName = FacebookRegistrationValidator.fullName;
        isIndian = FacebookRegistrationValidator.isIndian;
        dob = FacebookRegistrationValidator.dob;
        email = FacebookRegistrationValidator.email;
        mobileNumber = FacebookRegistrationValidator.mobileNumber;
...
class FacebookRegistrationValidator {
    static String fullName;
    static boolean isIndian;
    static String dob;
    static String email;
